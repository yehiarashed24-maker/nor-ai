  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 end-4 z-40 sm:bottom-6 sm:end-auto sm:start-8 sm:max-w-md">
        <div className="relative flex items-center justify-between gap-2 rounded-full border border-white/20 bg-[#0e0e0e]/95 p-2 shadow-2xl backdrop-blur-xl transition-all sm:gap-4 sm:rounded-2xl sm:p-4">
